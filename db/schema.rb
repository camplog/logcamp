...
ActiveRecord::Schema.define(version: 20150114165919) do
  ...
  create_table "applications_users", id: false, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["application_id", "user_id"], name: "index_applications_users_on_application_id_and_user_id", unique: true
    t.index ["application_id"], name: "index_applications_users_on_application_id"
    t.index ["user_id"], name: "index_applications_users_on_user_id"
  end
